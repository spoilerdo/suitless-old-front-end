...
<script>
  export default {
    ...
    methods: {
        choose(choice){
            this.dialog = false;
            this.$emit('agreeDisclaimer', choice);
        }
    }
  }
</script>