  ...
  <v-container fluid pa-0 ma-o>
    ...
    <v-layout align-center justify-center class="background-content-container" row wrap fill-height>
      ...
      <v-layout align-center justify-center row wrap>
        <RoundCard redirecturl='/survey/5cac95e3c00a700008e56810'  imagename="IP.svg" text="Privacy" cardWidth="xs6 md3" direction="column"/>
        <RoundCard redirecturl="/survey"  imagename="IP.svg" text="Privacy" cardWidth="xs6 md3" direction="column"/>
        <RoundCard redirecturl="/survey"  imagename="IP.svg" text="Privacy" cardWidth="xs6 md3" direction="column"/>
      </v-layout>
    </v-layout>
